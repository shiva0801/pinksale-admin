               ...
               <Form form={form} onFinish={validate}>
                ...
                <div className='bnb_description'>
                    <div className='bnb_description_main'>
                        ...
                        >
                            <Input type={"number"} placeholder="10000000" />
                            <p style={{color:"#fe6200"}}>Softcap must be positive number</p>
                           <div className='checkbox_item'>
                          <span className='input_container'><input type="checkbox" /></span>
                ...
                <div className='bnb_description'>
                    <div className='bnb_description_main'>
                        <label htmlFor="Softcap (BNB)">Router*<span style={{ color: "#FA6200" }}>*</span></label>
                        <Form.Item
                            name="minimumbuy"
