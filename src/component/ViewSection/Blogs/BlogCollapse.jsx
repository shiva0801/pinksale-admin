    ...
    return (
        <Collapse onChange={onChange}>
            ...
            <Panel header="What is KYC?" key="1">
                <p>Know Your Customer (KYC) is a process whereby the project owner has shared their identification documents with Metasale_Admin. KYC is used as a deterrent method to reduce illicit and deceptive behaviour.
                    ...
                    More information on Metasale_Admin KYC process can be seen explained in here:https://docs.Metasale_Admin.finance/important/Metasale_Admin-kyc.</p>
            </Panel>
            ...
            <Panel header="What is SAFU?" key="3">
                <p>The SAFU badge demonstrates that the contract has been created by a Metasale_Admin verified partner. SAFU benefits can be found via:https://docs.Metasale_Admin.finance/important/safu-contract.</p>
            </Panel>
            <Panel header="What is Doxx?" key="4">
                <p>Projects certified with the Doxx badge highlights that the projects owner has completed a video AMA within their community, and that their submission to Metasale_Admin matches their KYC information.
                    More information on Metasale_Admin Doxx badge can be seen explained in here:https://docs.Metasale_Admin.finance/important/Metasale_Admin-kyc.</p>
            </Panel>
